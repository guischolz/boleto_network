...
// Receives 4 parameters =  [0] Symbol [1] TotalSupply   [2] Deion  [3] Owner
func (token *ERC20TokenChaincode) Init(stub shim.ChaincodeStubInterface) peer.Response {
	...
	var erc20 = ERC20Token{Symbol: symbol, TotalSupply: totalSupply, Deion: string(args[2]), Creator: creator}
